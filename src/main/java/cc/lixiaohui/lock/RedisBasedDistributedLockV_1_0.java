 ...
 * 
 * @author lixiaohui
 * @version V_1_0 初始版本,问题: 时间未协调, non-reentrant
 */
public class RedisBasedDistributedLockV_1_0 extends AbstractLock {
	...
	public RedisBasedDistributedLockV_1_0(Jedis jedis, String lockKey, long lockExpires) {
		this.jedis = jedis;
